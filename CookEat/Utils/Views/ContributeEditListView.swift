...
struct ContributeEditListView: View {
    ...
    var body: some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 10)
                .stroke((addedIngredients.isEmpty && removedIngredients.isEmpty) ? Color(.systemGray3) : Color.green, lineWidth: 2)
        )
        .frame(height:200)
        ...
        VStack{
            ...
            RoundedRectangle(cornerRadius: 10)
                .stroke((addedInstructions.isEmpty && removedInstructions.isEmpty) ? Color(.systemGray3) : Color.green, lineWidth: 2)
        )
        .frame(height:200)
    }
